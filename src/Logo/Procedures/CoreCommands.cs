...
namespace Logo.Procedures
{
    ...
    public class CoreCommands : ICommandModule
    {
        ...
        //{
        //    ListToken clonedList;
        //    if (input[0].GetType() == typeof(ListToken))
        //    {
        //        clonedList = (ListToken)input[0].Clone();
        //    }
        ...
        //    else
        //    {
        //        clonedList = (ListToken)input[0].TokenValue.Value;
        //    }
        ...
        //    }
        //    else if (input[1].GetType() == typeof(ListToken))
        //    {
        ...
        //    ListToken inputList = (ListToken)input[0].TokenValue.Value;
        ...
        //        return null;
        //    }
        //    return new Token { Evaluated = true, Text = "abs", TokenValue = new LogoValue(LogoValueType.Number, Math.Abs((decimal)input[0].TokenValue.Value))};
        //}
        ...
        //{
        //    return new Token { Evaluated = true, Text = Math.PI.ToString(CultureInfo.InvariantCulture), TokenValue = new LogoValue(LogoValueType.Number, (decimal)Math.PI)};
        //}
        ...
        //    return new Token { Evaluated = true, Text = "space", TokenValue = val };
        //}
        ...
        //            Evaluated = true,
        //            Text = "count",
        //            TokenValue = new LogoValue(LogoValueType.Number, (decimal)(parameters[0].TokenValue.Value as ListToken).Contents.Count),
        //        };
        //    }
        //    return new Token
        //    {
